...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-1.png){:class='screenshot' style='width:33%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-6.png){:class='screenshot' style='width:33%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-13.png){:class='screenshot' style='width:50%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-14.png){:class='screenshot' style='width:50%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-15.png){:class='screenshot' style='width:50%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-19.png){:class='screenshot' style='width:50%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-20.png){:class='screenshot' style='width:50%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-22.png){:class='screenshot' style='width:33%;'}

It is also possible to use the drop-down menu on the **More** button to select the column to sort under the **Sort By** option.

![Student Scheduling Dashboard Manual](images/scheduling-dashboard-23.png){:class='screenshot' style='width:33%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-24.png){:class='screenshot' style='width:33%;'}
...
* **Class** - This label applies to the individual class sections listed under a course if the plus icon ![+](../images/icon-filter-open.gif) next to it has been clicked to show the class section data.  If a class section is displayed, its section number or External ID is listed here.
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-26.png){:class='screenshot'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-28.png){:class='screenshot'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-29.png){:class='screenshot'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-30.png){:class='screenshot'}

The data on the **Students** table can be sorted by any column listed on the table.  To do this, click on the column label for the column and use the **Sort by** option.  The first Sort on the column sorts the table by the data in ascending order.  The second Sort on the column sorts the table by the data in descending order.

It is also possible to use the drop-down menu on the **More** button to select the column to sort under the **Sort By** option.

![Student Scheduling Dashboard Manual](images/scheduling-dashboard-31.png){:class='screenshot' style='width:33%;'}

To show/hide a certain column, use the drop-down menu on the **More** button to select the column to sort under the **Column** option.

![Student Scheduling Dashboard Manual](images/scheduling-dashboard-32.png){:class='screenshot' style='width:33%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-34.png){:class='screenshot' style='width:33%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-36.png){:class='screenshot' style='width:50%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-35.png){:class='screenshot' style='width:33%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-37.png){:class='screenshot' style='width:50%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-38.png){:class='screenshot' style='width:50%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-39.png){:class='screenshot' style='width:50%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-41.png){:class='screenshot' style='width:33%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-43.png){:class='screenshot' style='width:33%;'}

To show/hide a certain column, use the drop-down menu on the **More** button to select the column to sort under the **Column** option.

![Student Scheduling Dashboard Manual](images/scheduling-dashboard-44.png){:class='screenshot' style='width:33%;'}
...
![Student Scheduling Dashboard Manual](images/scheduling-dashboard-46.png){:class='screenshot' style='width:50%;'}
